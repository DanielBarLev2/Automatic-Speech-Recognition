...
def prepare_mel_spectrogram(class_repr_audio: torch.Tensor,
    ...
    mel_spec = MelSpectrogram(sample_rate=Config.SAMPLE_RATE,
                              ...
                              hop=Config.HOP,
                              n_mels=Config.N_FILTER,
                              device=Config.DEVICE)

    mel_spec.display_samples(audio_tensor=training_set_audio[:10], num_samples=4)
    mel_spec.display_samples(audio_tensor=training_set_audio[20:30], num_samples=4)
